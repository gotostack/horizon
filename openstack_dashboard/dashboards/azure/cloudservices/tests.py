...
INDEX_URL = reverse('horizon:azure:cloudservices:index')
...
class CloudServicesViewTests(helpers.TestCase):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'azure/cloudservices/index.html')
    ...
    def test_create_cloud_service_get(self):
        ...
        url = reverse('horizon:azure:cloudservices:create')
        res = self.client.get(url)

        self.assertTemplateUsed(
            res,
            'azure/cloudservices/create_cloudservice.html')
        self.assertContains(
    ...
    def test_cloud_service_detail_get(self):
        ...
        url = reverse('horizon:azure:cloudservices:detail',
                      args=[cloud_service.service_name])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'azure/cloudservices/detail.html')
