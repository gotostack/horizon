...
from openstack_dashboard.dashboards.azure.cloudservices \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'azure/cloudservices/index.html'
...
class CreateCloudServiceView(forms.ModalFormView):
    ...
    template_name = 'azure/cloudservices/create_cloudservice.html'
    success_url = reverse_lazy('horizon:azure:cloudservices:index')
...
class DetailView(tabs.TabView):
    ...
    template_name = 'azure/cloudservices/detail.html'
    redirect_url = 'horizon:azure:cloudservices:index'
