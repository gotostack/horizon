...
INDEX_URL = reverse('horizon:azure:overview:index')
...
class UsageViewTests(test.TestCase):
    ...
    def _test_usage(self, nova_stu_enabled):
        ...
        res = self.client.get(reverse('horizon:azure:overview:index'))
        usages = res.context['usage']
        self.assertTemplateUsed(res, 'azure/overview/usage.html')
    ...
    def test_unauthorized(self):
        ...
        url = reverse('horizon:azure:overview:index')
    ...
    def _test_usage_csv(self, nova_stu_enabled=True):
        ...
        res = self.client.get(reverse('horizon:azure:overview:index') +
                              "?format=csv")
        self.assertTemplateUsed(res, 'azure/overview/usage.csv')
