...
from openstack_dashboard.dashboards.azure.disks \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'azure/disks/index.html'
...
class DetailView(tabs.TabView):
    ...
    template_name = 'azure/disks/detail.html'
    redirect_url = 'horizon:azure:disks:index'
    ...
    def get_data(self):
        ...
        try:
            ...
            disk = None
            redirect = reverse("horizon:azure:disks:index")
            exceptions.handle(self.request,
