...
class AllocateIP(tables.LinkAction):
    ...
    classes = ("ajax-modal",)
    icon = "link"
    url = "horizon:user:access_and_security:floating_ips:allocate"

    def single(self, data_table, request, *args):
        return shortcuts.redirect('horizon:user:access_and_security:index')
...
class AssociateIP(tables.LinkAction):
    ...
    url = "horizon:user:access_and_security:floating_ips:associate"
    classes = ("ajax-modal",)
    icon = "link"
...
def get_instance_info(fip):
    ...
    elif fip.instance_type == 'loadbalancerv2':
        return _("Load Balancer v2 VIP %s") % fip.fixed_ip
