...
class AllocateView(forms.ModalFormView):
    ...
    template_name = 'user/access_and_security/floating_ips/allocate.html'
    submit_label = _("Allocate IP")
    submit_url = reverse_lazy(
        "horizon:user:access_and_security:floating_ips:allocate")
    ...
    def get_context_data(self, **kwargs):
        ...
        # try:
        #     context['usages'] = quotas.tenant_network_quota_usages(
        #         self.request)
        # except Exception:
