...
class DetailView(tables.DataTableView):
    ...
    template_name = 'user/access_and_security/security_groups/detail.html'
    ...
    def _get_data(self):
        ...
        try:
            ...
            redirect = reverse('horizon:user:access_and_security:index')
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'user/access_and_security/security_groups/update.html'
    submit_label = _("Edit Security Group")
    submit_url = "horizon:user:access_and_security:security_groups:update"
    success_url = reverse_lazy('horizon:user:access_and_security:index')
    ...
    def get_object(self):
        ...
        try:
            ...
            url = reverse('horizon:user:access_and_security:index')
...
class AddRuleView(forms.ModalFormView):
    ...
    template_name = 'user/access_and_security/security_groups/add_rule.html'
    submit_label = _("Add")
    submit_url = "horizon:user:access_and_security:security_groups:add_rule"
    page_title = _("Add Rule")

    def get_success_url(self):
        sg_id = self.kwargs['security_group_id']
        return reverse("horizon:user:access_and_security:"
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'user/access_and_security/security_groups/create.html'
    submit_label = _("Create Security Group")
    submit_url = reverse_lazy(
        "horizon:user:access_and_security:security_groups:create")
    success_url = reverse_lazy('horizon:user:access_and_security:index')
