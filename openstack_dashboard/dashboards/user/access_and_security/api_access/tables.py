...
class DownloadEC2(tables.LinkAction):
    ...
    icon = "download"
    url = "horizon:user:access_and_security:api_access:ec2"
...
class DownloadOpenRC(tables.LinkAction):
    ...
    icon = "download"
    url = "horizon:user:access_and_security:api_access:openrc"
...
class ViewCredentials(tables.LinkAction):
    ...
    classes = ("ajax-modal", )
    icon = "plus"
    url = "horizon:user:access_and_security:api_access:view_credentials"
