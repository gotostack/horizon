...
from openstack_dashboard.dashboards.user.networks.subnets import utils
from openstack_dashboard.dashboards.user.networks.subnets \
    import workflows as user_workflows


class CreateView(workflows.WorkflowView):
    workflow_class = user_workflows.CreateSubnet
...
class UpdateView(workflows.WorkflowView):
    workflow_class = user_workflows.UpdateSubnet
...
class DetailView(tabs.TabView):
    tab_group_class = user_tabs.SubnetDetailTabs
    template_name = 'user/networks/subnets/detail.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        table = user_tables.SubnetsTable(self.request,
