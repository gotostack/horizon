...
class IndexView(tables.DataTableView):
    table_class = user_tables.NetworksTable
    template_name = 'user/networks/index.html'
...
class CreateView(workflows.WorkflowView):
    workflow_class = user_workflows.CreateNetwork
    ajax_template_name = 'user/networks/create.html'


class UpdateView(forms.ModalFormView):
    context_object_name = 'network'
    form_class = user_forms.UpdateNetwork
    form_id = "update_network_form"
    modal_header = _("Edit Network")
    submit_label = _("Save Changes")
    submit_url = "horizon:user:networks:update"
    success_url = reverse_lazy("horizon:user:networks:index")
    template_name = 'user/networks/update.html'
...
class DetailView(tables.MultiTableView):
    ...
    def get_context_data(self, **kwargs):
        ...
        table = user_tables.NetworksTable(self.request)
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:user:networks:index')
