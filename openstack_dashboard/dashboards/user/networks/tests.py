...
from openstack_dashboard.dashboards.user.networks.subnets import tables\
    as subnets_tables
from openstack_dashboard.dashboards.user.networks import tables\
    as networks_tables
from openstack_dashboard.dashboards.user.networks import workflows
from openstack_dashboard.test import helpers as test
from openstack_dashboard.usage import quotas

INDEX_URL = reverse('horizon:user:networks:index')
...
class NetworkTests(test.TestCase):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'user/networks/index.html')
    ...
    def _test_network_detail(self, mac_learning=False):
        ...
        res = self.client.get(reverse('horizon:user:networks:detail',
                                      args=[network_id]))
    ...
    def _test_network_detail_network_exception(self, mac_learning=False):
        ...
        url = reverse('horizon:user:networks:detail', args=[network_id])
    ...
    def test_network_create_get(self,
        ...
        url = reverse('horizon:user:networks:create')
        res = self.client.get(url)
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:user:networks:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'user/networks/update.html')
...
class NetworkSubnetTests(test.TestCase):
    ...
    def test_subnet_detail(self):
        ...
        url = reverse('horizon:user:networks:subnets:detail',
                      args=[subnet.id])
        res = self.client.get(url)
    ...
    def test_subnet_create_get(self):
        ...
        url = reverse('horizon:user:networks:addsubnet',
                      args=[network.id])
        res = self.client.get(url)
    ...
    def test_subnet_create_post(self):
        ...
        self.assertNoFormErrors(res)
        redir_url = reverse('horizon:user:networks:detail',
                            args=[subnet.network_id])
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def test_subnet_update_post(self):
        ...
        form_data = form_data_subnet(subnet,
                                     allocation_pools=[])
        url = reverse('horizon:user:networks:editsubnet',
    ...
    def _test_subnet_delete(self, mac_learning=False):
        ...
        url = reverse('horizon:user:networks:detail',
                      args=[network_id])
        res = self.client.post(url, form_data)
...
class NetworkPortTests(test.TestCase):
    ...
    def _test_port_detail(self, mac_learning=False):
        ...
        res = self.client.get(reverse('horizon:user:networks:ports:detail',
                                      args=[port.id]))
    ...
    def _test_port_update_get(self, mac_learning=False, binding=False):
        ...
        url = reverse('horizon:user:networks:editport',
                      args=[port.network_id, port.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'user/networks/ports/update.html')
