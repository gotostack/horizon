...
from openstack_dashboard.dashboards.user.routers\
    import forms as user_forms
from openstack_dashboard.dashboards.user.routers import tables as rtables
from openstack_dashboard.dashboards.user.routers import tabs as rdtabs


class IndexView(tables.DataTableView):
    table_class = rtables.RoutersTable
    template_name = 'user/routers/index.html'
...
class DetailView(tabs.TabbedTableView):
    ...
    template_name = 'user/routers/detail.html'
    failure_url = reverse_lazy('horizon:user:routers:index')
...
class CreateView(forms.ModalFormView):
    form_class = user_forms.CreateForm
    form_id = "create_router_form"
    modal_header = _("Create Router")
    template_name = 'user/routers/create.html'
    success_url = reverse_lazy("horizon:user:routers:index")
    page_title = _("Create Router")
    submit_label = _("Create Router")
    submit_url = reverse_lazy("horizon:user:routers:create")
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:user:routers:update"
