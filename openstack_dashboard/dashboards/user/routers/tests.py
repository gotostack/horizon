...
from openstack_dashboard.dashboards.user.routers.extensions.routerrules\
    import rulemanager
from openstack_dashboard.dashboards.user.routers import tables
...
class RouterActionTests(RouterMixin, test.TestCase):
    ...
    def test_router_update_get_dvr_disabled(self):
        ...
        self.assertTemplateUsed(res, 'user/routers/update.html')
...
class RouterViewTests(RouterMixin, test.TestCase):
    ...
    def test_create_button_disabled_when_quota_exceeded(self):
        ...
        res = self.client.get(self.INDEX_URL)
        self.assertTemplateUsed(res, 'user/routers/index.html')
