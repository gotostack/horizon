...
from openstack_dashboard.dashboards.user.routers.ports \
...
class AddInterfaceView(forms.ModalFormView):
    form_class = user_forms.AddInterface
    template_name = 'user/routers/ports/create.html'
    success_url = 'horizon:user:routers:detail'
    failure_url = 'horizon:user:routers:detail'
...
class SetGatewayView(forms.ModalFormView):
    form_class = user_forms.SetGatewayForm
    template_name = 'user/routers/ports/setgateway.html'
    success_url = 'horizon:user:routers:index'
    failure_url = 'horizon:user:routers:index'
