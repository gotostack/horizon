...
from openstack_dashboard.dashboards.lecloud.instances import workflows
from openstack_dashboard.test import helpers

INDEX_URL = reverse('horizon:lecloud:instances:index')
...
class InstanceTests(helpers.TestCase):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'lecloud/instances/index.html')
    ...
    def test_launch_instance_get(self):
        ...
        url = reverse('horizon:lecloud:instances:launch')
    ...
    def test_resize_instance_get(self):
        ...
        url = reverse('horizon:lecloud:instances:resize',
    ...
    def test_update_instance_get(self):
        ...
        url = reverse('horizon:lecloud:instances:update',
                      args=[cloud_service.service_name,
                            deployment.name,
                            server.role_name])
        res = self.client.get(url)
    ...
    def test_add_endpoint_instance_get(self):
        ...
        cloud_service = self.azure_cloud_services.first()
        deployment = self.azure_deployments.first()
        url = reverse('horizon:lecloud:instances:addendpoint',
                      args=[cloud_service.service_name,
                            deployment.name,
                            server.role_name])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'lecloud/instances/add_endpoint.html')
    ...
    def test_remove_endpoint_instance_get(self):
        ...
        api.azure_api.virtual_machine_get(
            ...
            server.role_name).AndReturn(role)
        self.mox.ReplayAll()
        url = reverse('horizon:lecloud:instances:removeendpoint',
                      args=[cloud_service.service_name,
                            deployment.name,
                            server.role_name])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'lecloud/instances/remove_endpoint.html')
    ...
    def test_attatch_datadisk_instance_get(self):
        ...
        url = reverse('horizon:lecloud:instances:attach',
                      args=[cloud_service.service_name,
                            deployment.name,
                            server.role_name])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'lecloud/instances/attach_datadisk.html')
    ...
    def test_deattach_datadisk_instance(self):
        ...
        url = reverse('horizon:lecloud:instances:deattach',
                      args=[cloud_service.service_name,
                            deployment.name,
                            server.role_name])
        form_data = {
    ...
    def test_instance_detail_get(self):
        ...
        url = reverse('horizon:lecloud:instances:detail',
                      args=[cloud_service.service_name,
                            deployment.name,
                            server.role_name])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'lecloud/instances/detail.html')
        self.assertContains(
