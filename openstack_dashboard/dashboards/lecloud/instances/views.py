...
from openstack_dashboard.dashboards.lecloud.instances \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'lecloud/instances/index.html'
...
class DetailView(tabs.TabView):
    ...
    template_name = 'lecloud/instances/detail.html'
    redirect_url = 'horizon:lecloud:instances:index'
...
class UpdateView(workflows.WorkflowView):
    ...
    success_url = reverse_lazy("horizon:lecloud:instances:index")
...
class AddEndpointView(forms.ModalFormView):
    ...
    template_name = 'lecloud/instances/add_endpoint.html'
    success_url = reverse_lazy('horizon:lecloud:instances:index')
...
class RemoveEndpointView(AddEndpointView):
    ...
    template_name = 'lecloud/instances/remove_endpoint.html'
...
class AttachDataDiskView(AddEndpointView):
    ...
    template_name = 'lecloud/instances/attach_datadisk.html'
...
class DeattachDataDiskView(AddEndpointView):
    ...
    template_name = 'lecloud/instances/deattach_datadisk.html'
