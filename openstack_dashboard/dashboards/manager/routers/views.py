...
from openstack_dashboard.dashboards.manager.networks import views as n_views
from openstack_dashboard.dashboards.manager.routers import forms as rforms
from openstack_dashboard.dashboards.manager.routers import tables as rtbl
from openstack_dashboard.dashboards.manager.routers import tabs as rtabs
from openstack_dashboard.dashboards.user.routers import views as r_views


class IndexView(r_views.IndexView, n_views.IndexView):
    table_class = rtbl.RoutersTable
    template_name = 'manager/routers/index.html'
...
class DetailView(r_views.DetailView):
    ...
    template_name = 'manager/routers/detail.html'
    failure_url = reverse_lazy('horizon:manager:routers:index')
...
class UpdateView(r_views.UpdateView):
    ...
    template_name = 'user/routers/update.html'
    success_url = reverse_lazy("horizon:manager:routers:index")
    submit_url = "horizon:manager:routers:update"
