...
from openstack_dashboard.dashboards.user.routers import tables as r_tables


class DeleteRouter(r_tables.DeleteRouter):
    redirect_url = "horizon:manager:routers:index"


class EditRouter(r_tables.EditRouter):
    url = "horizon:manager:routers:update"
...
class RoutersTable(r_tables.RoutersTable):
    ...
    name = tables.Column("name",
                         verbose_name=_("Name"),
                         link="horizon:manager:routers:detail")
