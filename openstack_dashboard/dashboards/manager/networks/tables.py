...
class DeleteNetwork(policy.PolicyTargetMixin, tables.DeleteAction):
    ...
    def delete(self, request, obj_id):
        try:
            ...
            LOG.info(msg)
            redirect = reverse('horizon:manager:networks:index')
...
class CreateNetwork(tables.LinkAction):
    ...
    url = "horizon:manager:networks:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditNetwork(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:manager:networks:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class NetworksTable(tables.DataTable):
    ...
    name = tables.Column("name_or_id", verbose_name=_("Network Name"),
                         link='horizon:manager:networks:detail')
