...
from openstack_dashboard.dashboards.user.networks import views as user_views

from openstack_dashboard.dashboards.manager.networks.agents \
    import tables as agents_tables
from openstack_dashboard.dashboards.manager.networks \
    import forms as project_forms
from openstack_dashboard.dashboards.manager.networks.ports \
    import tables as ports_tables
from openstack_dashboard.dashboards.manager.networks.subnets \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'manager/networks/index.html'
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'manager/networks/create.html'
    success_url = reverse_lazy('horizon:manager:networks:index')
...
class DetailView(tables.MultiTableView):
    ...
    template_name = 'user/networks/detail.html'
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:manager:networks:index')


class UpdateView(user_views.UpdateView):
    form_class = project_forms.UpdateNetwork
    template_name = 'manager/networks/update.html'
    success_url = reverse_lazy('horizon:manager:networks:index')
    submit_url = "horizon:manager:networks:update"
