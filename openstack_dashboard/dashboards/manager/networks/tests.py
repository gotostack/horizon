...
from openstack_dashboard.dashboards.user.networks import tests
from openstack_dashboard.test import helpers as test


INDEX_URL = reverse('horizon:manager:networks:index')
...
class NetworkTests(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'manager/networks/index.html')
    ...
    def _test_network_detail(self, mac_learning=False):
        ...
        res = self.client.get(reverse('horizon:manager:networks:detail',
                                      args=[network_id]))

        self.assertTemplateUsed(res, 'user/networks/detail.html')
    ...
    def _test_network_detail_network_exception(self, mac_learning=False):
        ...
        url = reverse('horizon:manager:networks:detail', args=[network_id])
    ...
    def test_network_create_get(self,
        ...
        url = reverse('horizon:manager:networks:create')
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'manager/networks/create.html')
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:manager:networks:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'manager/networks/update.html')
...
class NetworkSubnetTests(test.BaseAdminViewTests):
    ...
    def test_subnet_detail(self):
        ...
        url = reverse('horizon:manager:networks:subnets:detail',
                      args=[subnet.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'user/networks/subnets/detail.html')
    ...
    def test_subnet_detail_exception(self):
        ...
        redir_url = reverse('horizon:user:networks:index')
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def test_subnet_create_get(self):
        ...
        url = reverse('horizon:manager:networks:addsubnet',
                      args=[network.id])
        res = self.client.get(url)
    ...
    def test_subnet_create_post(self):
        ...
        self.assertNoFormErrors(res)
        redir_url = reverse('horizon:manager:networks:detail',
                            args=[subnet.network_id])
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def test_subnet_update_post(self):
        ...
        form_data = tests.form_data_subnet(subnet, allocation_pools=[])
        url = reverse('horizon:manager:networks:editsubnet',
    ...
    def _test_subnet_delete(self, mac_learning=False):
        ...
        url = reverse('horizon:manager:networks:detail',
                      args=[network_id])
        res = self.client.post(url, form_data)
...
class NetworkPortTests(test.BaseAdminViewTests):
    ...
    def _test_port_detail(self, mac_learning=False):
        ...
        res = self.client.get(reverse('horizon:manager:networks:ports:detail',
                                      args=[port.id]))

        self.assertTemplateUsed(res, 'user/networks/ports/detail.html')
    ...
    def test_port_detail_exception(self):
        ...
        # admin DetailView is shared with userpanel one, so
        # redirection URL on error is userpanel index.
        redir_url = reverse('horizon:manager:networks:index')
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def _test_port_create_get(self, mac_learning=False, binding=False):
        ...
        url = reverse('horizon:manager:networks:addport',
                      args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'manager/networks/ports/create.html')
    ...
    def _test_port_update_get(self, mac_learning=False, binding=False):
        ...
        url = reverse('horizon:manager:networks:editport',
                      args=[port.network_id, port.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'manager/networks/ports/update.html')
...
class NetworkAgentTests(test.BaseAdminViewTests):
    ...
    def test_agent_add_get(self):
        ...
        url = reverse('horizon:manager:networks:adddhcpagent',
                      args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'manager/networks/agents/add.html')
