...
class CreateView(forms.ModalFormView):
    ...
    submit_url = "horizon:manager:networks:addport"
    page_title = _("Create Port")
    template_name = 'manager/networks/ports/create.html'
    url = 'horizon:manager:networks:detail'
...
class DetailView(project_views.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["url"] = reverse('horizon:manager:networks:index')
        context["actions"] = table.render_row_actions(port)
        return context

    @staticmethod
    def get_redirect_url():
        return reverse('horizon:manager:networks:index')


class UpdateView(project_views.UpdateView):
    form_class = ports_forms.UpdatePort
    template_name = 'manager/networks/ports/update.html'
    context_object_name = 'port'
    submit_url = "horizon:manager:networks:editport"
    success_url = 'horizon:manager:networks:detail'
