...
from openstack_dashboard.dashboards.user.networks.ports import \
...
class CreatePort(tables.LinkAction):
    ...
    url = "horizon:manager:networks:addport"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdatePort(project_tables.UpdatePort):
    url = "horizon:manager:networks:editport"


class PortsTable(project_tables.PortsTable):
    name = tables.Column("name_or_id",
                         verbose_name=_("Name"),
                         link="horizon:manager:networks:ports:detail")
