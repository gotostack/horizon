...
class IndexView(tabs.TabbedTableView):
    ...
    template_name = 'manager/loadbalancers/index.html'
...
class LoadbalancerDetailView(tabs.TabbedTableView):
    ...
    template_name = 'manager/loadbalancers/loadbalancer_detail.html'
    failure_url = reverse_lazy('horizon:manager:loadbalancers:index')
...
class LoadbalancerStatusesDetailView(forms.ModalFormMixin,
    ...
    template_name = 'manager/loadbalancers/loadbalancer_statuses.html'
    ...
    def get_object(self):
        try:
            ...
            redirect = reverse("horizon:manager:loadbalancers:index")
...
class ListenerDetailsView(tabs.TabbedTableView):
    ...
    template_name = 'manager/loadbalancers/listener_detail.html'
    failure_url = reverse_lazy('horizon:manager:loadbalancers:index')
...
class PoolDetailsView(tabs.TabbedTableView):
    ...
    template_name = 'manager/loadbalancers/pool_detail.html'
    failure_url = reverse_lazy('horizon:manager:loadbalancers:index')
...
class UpdateLoadbalancerView(forms.ModalFormView):
    ...
    template_name = "manager/loadbalancers/updateloadbalancer.html"
    context_object_name = 'loadbalancer'
    submit_label = _("Save Changes")
    submit_url = "horizon:manager:loadbalancers:updateloadbalancer"
...
class UpdateListenerView(forms.ModalFormView):
    ...
    template_name = "manager/loadbalancers/updatelistener.html"
    context_object_name = 'listener'
    submit_label = _("Save Changes")
    submit_url = "horizon:manager:loadbalancers:updatelistener"
    success_url = reverse_lazy("horizon:manager:loadbalancers:index")
...
class UpdatePoolView(forms.ModalFormView):
    ...
    template_name = "manager/loadbalancers/updatepool.html"
    context_object_name = 'pool'
    submit_label = _("Save Changes")
    submit_url = "horizon:manager:loadbalancers:updatepool"
    success_url = reverse_lazy("horizon:manager:loadbalancers:index")
...
class UpdateMemberView(forms.ModalFormView):
    ...
    template_name = "manager/loadbalancers/updatemember.html"
    context_object_name = 'member'
    submit_label = _("Save Changes")
    submit_url = "horizon:manager:loadbalancers:updatemember"
    success_url = "horizon:manager:loadbalancers:pooldetails"
...
class UpdateAclView(forms.ModalFormView):
    ...
    template_name = "manager/loadbalancers/updateacl.html"
...
class UpdateHealthmonitorView(forms.ModalFormView):
    ...
    template_name = "manager/loadbalancers/updatehealthmonitor.html"
    context_object_name = 'healthmonitor'
    submit_label = _("Save Changes")
    submit_url = "horizon:manager:loadbalancers:updatehealthmonitor"
    success_url = reverse_lazy("horizon:manager:loadbalancers:index")
