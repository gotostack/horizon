...
class AddLoadbalancerLink(tables.LinkAction):
    ...
    url = "horizon:manager:loadbalancers:addloadbalancer"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateLoadbalancerLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, loadbalancer):
        base_url = reverse("horizon:manager:loadbalancers:updateloadbalancer",
...
class AddListenerLink(tables.LinkAction):
    ...
    url = "horizon:manager:loadbalancers:addlistener"
    classes = ("ajax-modal",)
    icon = "plus"
...
class ViewLoadbalancerStatuses(tables.LinkAction):
    ...
    url = "horizon:manager:loadbalancers:loadbalancerstatuses"
...
class UpdateListenerLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, listener):
        base_url = reverse("horizon:manager:loadbalancers:updatelistener",
...
class AddAclToListenerLink(tables.LinkAction):
    ...
    url = "horizon:manager:loadbalancers:addacl"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdatePoolLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, pool):
        base_url = reverse("horizon:manager:loadbalancers:updatepool",
...
class AddMemberToPoolLink(tables.LinkAction):
    ...
    url = "horizon:manager:loadbalancers:addmember"
    classes = ("ajax-modal",)
    icon = "plus"
...
class AddHealthmonitorLink(tables.LinkAction):
    ...
    url = "horizon:manager:loadbalancers:addhealthmonitor"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateMemberLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, member):
        base_url = reverse("horizon:manager:loadbalancers:updatemember",
...
class UpdateAclLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, acl):
        base_url = reverse("horizon:manager:loadbalancers:updateacl",
...
class UpdateHealthmonitorLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, healthmonitor):
        base_url = reverse("horizon:manager:loadbalancers:updatehealthmonitor",
...
class AddLVSPortLink(tables.LinkAction):
    ...
    url = "horizon:manager:loadbalancers:addlvsport"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateLVSPortLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, datum):
        base_url = reverse("horizon:manager:loadbalancers:updatelvsport",
