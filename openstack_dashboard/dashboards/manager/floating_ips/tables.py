...
def get_instance_link(datum):
    view = "horizon:manager:instances:detail"
...
def get_port_link(datum):
    view = "horizon:manager:networks:ports:detail"
    if datum.port_id:
...
def get_floating_network_link(datum):
    view = "horizon:manager:networks:detail"
...
class AdminAllocateFloatingIP(tables.LinkAction):
    ...
    url = "horizon:manager:floating_ips:allocate"
...
class AdminEditFloatingIP(tables.LinkAction):
    name = "edit"
    verbose_name = _("Edit")
    url = "horizon:manager:floating_ips:update"
...
class FloatingIPsTable(tables.DataTable):
    ...
    ip = tables.Column("ip",
                       link=("horizon:manager:floating_ips:detail"),
