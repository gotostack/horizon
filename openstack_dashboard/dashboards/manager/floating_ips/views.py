...
from openstack_dashboard.dashboards.manager.floating_ips \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'manager/floating_ips/index.html'
...
class DetailView(tabs.TabView):
    ...
    template_name = 'manager/floating_ips/detail.html'


class AllocateView(forms.ModalFormView):
    form_class = fip_forms.AdminFloatingIpAllocate
    template_name = 'manager/floating_ips/allocate.html'
    success_url = reverse_lazy('horizon:manager:floating_ips:index')
